...
namespace SqlDbFrameworkNetCore.Repositories
{
    ...
    public interface IRepository
    {
        ...
        T FindByKey<T>(Expression<Func<T, object>> key, object value);
        /// <summary>
        ...
        T FindFirst<T>(Expression<Func<T, bool>> predicate);
        /// <summary>
        ...
        /// <exception cref="InvalidOperationException"></exception>
        /// <exception cref="NullReferenceException"></exception>
        void RemoveAll<T>(Expression<Func<T, bool>> predicate);
        /// <summary>
        ...
        /// <exception cref="InvalidOperationException"></exception>
        /// <exception cref="NullReferenceException"></exception>
        void RemoveRange<T>(IEnumerable<T> items);
        ...
        void Set<T>(Expression<Func<T, bool>> predicate, object newValue);
        /// <summary>
        ...
        void Set<T>(T oldValue, T newValue);
    }
